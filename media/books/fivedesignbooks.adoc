...
The http://www.classiccmp.org/cini/pdf/Apple/Apple%20II%20Basic%20Programming%20Manual.pdf[Apple II BASIC Programming Manual] got me into programming on the Apple II+, the https://hanshuebner.github.io/lmman/frontpage.html[Lisp Machine Manual] was another absorbing read that started me on Lisp machines and the first part of my career programming in Lisp, and in that tradition, the Macintosh Human Interface Guidelines made me want to be a Mac developer (Macs did not come with a copy of the Guidelines, but they should have…)
